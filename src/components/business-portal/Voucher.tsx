      ...
      <div className="card w-full sm:w-72 h-80 bg-base-100 shadow-xl">
        ...
        <div className="carousel w-full">
          <div id="img1" className="carousel-item relative w-full">
            ...
            <img src="https://cutewallpaper.org/cdn-cgi/mirage/dd19f2d06ebc24f541f142b37b4289ffa7de722a7607e39984c5c6dd4ce8defd/1280/24/upload-png/ico-convert-create-icons-from-png-amp-jpg-images-online.png" className="w-full" />
